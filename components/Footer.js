...
const Footer = () => (
  <footer
    id="footer"
    className="fixed bottom-0 right-0 left-0 border-t bg-white"
  >
    <section className="flex flex-col justify-center items-center py-4 px-8">
      <nav>
        <ul className="flex flex-wrap space-x-4 justify-center">
          ...
          <li>
            <Link href="/alphabet">
              <a className="underline">Alphabet</a>
            </Link>
          </li>
          <li>
            <Link href="/numbers">
              <a className="underline">Numbers</a>
            </Link>
          </li>
          <li>
            <Link href="/shapes">
